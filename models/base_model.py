...
class BaseModel():
    ...
    def to_json(self):
        ...
        new_dict.update({'created_at': datetime.datetime.strftime((self.created_at), format)})
        new_dict.update({'updated_at': datetime.datetime.strftime((self.updated_at), format)})
